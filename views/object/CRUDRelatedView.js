...
/**
 * CRUDRelatedView extends from a view and form a master-detail relation. This extends
 * to add / edit /delete detail records in relating master view.
 * 
 * 
 * @param {type} options
 * @returns {undefined}
...
function CRUDRelatedView(options) {
    ...
    /**
     * Saves original reference to entity CRUD view.
     */
    ...
    /**
     * Find records based on provided keyword (master key) input through (observer 
     * keyword property) and page number.
     * 
     * @param {type} page
     * @returns {undefined}
     */
    ...
    /**
     * Selects detail item by selection record observer.
     * 
     * @returns {undefined}
     */
